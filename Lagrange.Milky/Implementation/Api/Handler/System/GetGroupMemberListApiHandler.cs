...
public class GetGroupMemberListApiHandler(BotContext bot, EntityConvert entity) : IApiHandler<GetGroupMemberListApiParameter>
{
    ...
    public async Task<IApiResult> HandleAsync(GetGroupMemberListApiParameter parameter, CancellationToken token)
    {
        ...
        return IApiResult.Ok(members.Select(_entity.GroupMember));
    }
}