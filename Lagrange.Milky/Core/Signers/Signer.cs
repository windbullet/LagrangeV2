...
namespace Lagrange.Milky.Core.Signers;

public class Signer(ILogger<Signer> logger, IServiceProvider services, Protocols protocol, string url, string? proxyUrl) : IAndroidBotSignProvider
{
    ...
    private readonly ILogger<Signer> _logger = logger;
...
public static partial class LoggerHelper
{
    ...
    public static partial void LogWhiteListMatchFailed(this ILogger<Signer> logger, Exception e);
}
