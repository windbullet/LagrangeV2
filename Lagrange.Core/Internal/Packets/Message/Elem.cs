...
{
    [ProtoMember(1)] public string TextMsg { get; set; } = string.Empty;
    
    [ProtoMember(2)] public string Link { get; set; } = string.Empty;
...
internal partial class NotOnlineImage
{
    ...
    [ProtoMember(12)] public string ThumbUrl { get; set; } = string.Empty;

    [ProtoMember(13)] public uint Original { get; set; }

    [ProtoMember(14)] public string BigUrl { get; set; } = string.Empty;

    [ProtoMember(15)] public string OrigUrl { get; set; } = string.Empty;
    ...
    [ProtoMember(26)] public string Url400 { get; set; } = string.Empty;
