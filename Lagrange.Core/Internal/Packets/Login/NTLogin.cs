...
internal enum NTLoginRetCode {
  /** 140 022 000 */          K_LOGIN_ERROR_DEFAULT                            = 140022000,
  /** 140 022 001 */          K_LOGIN_ERROR_INVALID_PARAMETER                  = 140022001,
  /** 140 022 002 */          K_LOGIN_ERROR_SYSTEM_FAILED                      = 140022002,
  /** 140 022 003 */          K_LOGIN_ERROR_TIMEOUT_RETRY                      = 140022003,
  /** 140 022 004 */          K_LOGIN_ERROR_NEED_UPDATE                        = 140022004,
  /** 140 022 005 */          K_LOGIN_ERROR_FROZEN                             = 140022005,
  /** 140 022 006 */          K_LOGIN_ERROR_PROTECT                            = 140022006,
  /** 140 022 007 */          K_LOGIN_ERROR_STRICT                             = 140022007,
  /** 140 022 008 */          K_LOGIN_ERROR_PROOF_WATER                        = 140022008,
  /** 140 022 009 */          K_LOGIN_ERROR_REFUSE_PASSWORD_LOGIN              = 140022009,
  /** 140 022 010 */          K_LOGIN_ERROR_NEW_DEVICE                         = 140022010,
  /** 140 022 011 */          K_LOGIN_ERROR_UNUSUAL_DEVICE                     = 140022011,
  /** 140 022 012 */          K_LOGIN_ERROR_INVALID_COOKIE                     = 140022012,
  /** 140 022 013 */          K_LOGIN_ERROR_ACCOUNT_OR_PASSWORD_ERROR          = 140022013,
  /** 140 022 014 */          K_LOGIN_ERROR_EXPIRE_TICKET                      = 140022014,
  /** 140 022 015 */          K_LOGIN_ERROR_KICKED_TICKET                      = 140022015,
  /** 140 022 016 */          K_LOGIN_ERROR_ILLEGAL_TICKET                     = 140022016,
  /** 140 022 017 */          K_LOGIN_ERROR_SEC_BEAT                           = 140022017,
  /** 140 022 018 */          K_LOGIN_ERROR_ACCOUNT_NOT_UIN                    = 140022018,
  /** 140 022 019 */          K_LOGIN_ERROR_NEED_VERIFY_REAL_NAME              = 140022019,

  /** 150 022 020 */          K_LOGIN_ERROR_NICE_ACCOUNT_EXPIRED               = 150022020,
  /** 150 022 021 */          K_LOGIN_ERROR_BLACK_ACCOUNT                      = 150022021,
  /** 150 022 022 */          K_LOGIN_ERROR_TOO_OFTEN                          = 150022022,
  /** 150 022 023 */          K_LOGIN_ERROR_TOO_MANY_TIMES_TODAY               = 150022023,
  /** 150 022 024 */          K_LOGIN_ERROR_UNREGISTERED                       = 150022024,
  /** 150 022 025 */          K_LOGIN_ERROR_NICE_ACCOUNT_PARENT_CHILD_EXPIRED  = 150022025,
  /** 150 022 026 */          K_LOGIN_ERROR_SMS_INVALID                        = 150022026,
  /** 150 022 027 */          K_LOGIN_ERROR_TGTGT_EXCHANGE_A1_FORBID           = 150022027,
  /** 150 022 028 */          K_LOGIN_ERROR_REMIND_CANCELLED_STATUS            = 150022028,
  /** 150 022 029 */          K_LOGIN_ERROR_MULTIPLE_PASSWORD_INCORRECT        = 150022029,
}

internal enum NTLoginPasswordVerifyResult {
    /** 0 */                    K_LOGIN_ERROR_SUCCESS                            = 0,
    /** 1 */                    K_LOGIN_ERROR_SCAN                               = 1,
    /** 2 */                    K_LOGIN_ERROR_PASSWORD                           = 2,
}
