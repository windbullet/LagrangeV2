...
{
    public static BotMessage CreateCustomGroup(long groupUin, long memberUin, string memberCard, MessageChain chain)
    {
        ...
        return new BotMessage(chain, dummyMember, dummyGroup);
    }
    
    public static BotMessage CreateCustomFriend(long senderUin, string senderName, long receiverUin, string receiverName, MessageChain chain)
    {
        ...
        return new BotMessage(chain, dummySender, dummyReceiver);
    }
}